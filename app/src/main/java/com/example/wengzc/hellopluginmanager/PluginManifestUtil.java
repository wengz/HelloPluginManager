...
public class PluginManifestUtil {
    ...
    static void setManifestInfo(Context context, String apkPath, PluginInfo info)
    ...
    private static void setAttrs(PluginInfo info, String manifestXML)
            throws XmlPullParserException, IOException {
    ...
    private static void parseApplicationInfo(PluginInfo info,
    ...
    private static void addActivity(PluginInfo info, String namespace,
    ...
    private static void addService(PluginInfo info, String namespace,
                                   XmlPullParser parser) throws XmlPullParserException, IOException {
        int eventType = parser.getEventType();
    ...
    private static void addReceiver(PluginInfo info, String namespace,
                                    XmlPullParser parser) throws XmlPullParserException, IOException {
        int eventType = parser.getEventType();
